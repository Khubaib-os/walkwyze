...
// Export pants products array for use in other components
let pantsProducts = [];
...
const Pants = () => {
  ...
  useEffect(() => {
    const fetchPants = async () => {
      try {
        ...
        pantsProducts = transformedProducts;
  ...
  // Filter products based on gender and size
              ...
              <div className="flex-1">
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 text-gray-600">
                    <span>Waist {selectedProduct.size}</span>
                        ...
                        <div key={product.id} className="bg-white border border-gray-200 flex flex-col hover:shadow-lg transition-shadow min-w-[280px] flex-shrink-0 mx-3 relative">
                          ...
                          <div className="p-3 text-center flex flex-col justify-center flex-1">
                            ...
                            <div className="flex justify-center items-center gap-2 mb-1">
                              <p className="text-gray-600 text-xs">Waist {product.size}</p>
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Swift Pants</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the perfect blend of style and comfort with Swift pants collection. 
              From formal trousers to casual wear, experience premium quality fabrics and impeccable craftsmanship for every occasion.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              <h3 className="text-lg font-semibold text-black mb-3">Filter by Size (Waist)</h3>
              <div className="flex flex-wrap justify-center gap-2">
                {allSizes.map((size) => (
                  <button
                    key={size}
          ...
          {loading && (
            <div className="text-center py-12">
              <p className="text-gray-600">Loading pants...</p>
            </div>
          )}
          ...
          {!loading && filteredProducts.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-600">
                No pants found for {selectedGender !== "All" ? `${selectedGender}'s` : ""} 
                {selectedGender !== "All" && selectedSize !== "All" ? " with " : ""}
                {selectedSize !== "All" ? `waist size ${selectedSize}` : ""}
                {selectedGender === "All" && selectedSize === "All" ? "selected filters" : ""}
              </p>
              <button
                onClick={() => {
