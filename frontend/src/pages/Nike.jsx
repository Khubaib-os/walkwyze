...
// Export Nike products array for use in other components
let nikeProducts = [];
...
const Nike = () => {
  ...
  // Fetch Nike products from Supabase
  const fetchNikeProducts = async () => {
    try {
      ...
      nikeProducts = transformedProducts;
  ...
  // Fetch Nike jackets from jackets table
  const fetchNikeJackets = async () => {
    try {
      ...
      console.error('Error fetching Nike jackets:', error);
      setJackets([]);
    } finally {
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Nike</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Just Do It. Discover the latest Nike footwear collection featuring innovative designs, 
              premium comfort, and iconic style for every step of your journey.
            </p>
          </div>
          ...
          {/* Nike Jackets Section with Marquee Animation - SAME AS OTHER BRANDS */}
          {!jacketsLoading && jackets.length > 0 && (
            <div className="border-t border-gray-200 pt-12 pb-8 mt-12">
              {/* Centered Heading */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-black mb-2">Nike Jackets</h2>
                <p className="text-gray-600 text-sm">
                  Explore our premium Nike jacket collection
                </p>
              </div>
