...
// Export Adidas products array for use in other components
let adidasProducts = [];
...
const Adidas = () => {
  ...
  // Fetch Adidas products from Supabase
  const fetchAdidasProducts = async () => {
    try {
      ...
      adidasProducts = transformedProducts;
  ...
  // Fetch Adidas jackets from jackets table
  const fetchAdidasJackets = async () => {
    try {
      ...
      console.error('Error fetching Adidas jackets:', error);
      setJackets([]);
    } finally {
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Adidas</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Impossible is Nothing. Explore the latest Adidas footwear collection featuring innovative technologies, 
              premium comfort, and iconic three-stripe style for every step of your journey.
            </p>
          </div>
          ...
          {/* Adidas Jackets Section with Marquee Animation - SAME AS OTHER BRANDS */}
          {!jacketsLoading && jackets.length > 0 && (
            <div className="border-t border-gray-200 pt-12 pb-8 mt-12">
              {/* Centered Heading */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-black mb-2">Adidas Jackets</h2>
                <p className="text-gray-600 text-sm">
                  Explore our premium Adidas jacket collection
                </p>
              </div>
