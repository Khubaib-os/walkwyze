...
// Export Puma products array for use in other components
let pumaProducts = [];
...
const Puma = () => {
  ...
  // Fetch Puma products from Supabase
  const fetchPumaProducts = async () => {
    try {
      ...
      pumaProducts = transformedProducts;
  ...
  // Fetch Puma jackets from jackets table
  const fetchPumaJackets = async () => {
    try {
      ...
      console.error('Error fetching Puma jackets:', error);
      setJackets([]);
    } finally {
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Puma</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Forever Faster. Explore the latest Puma footwear collection featuring innovative designs, 
              bold styles, and performance technologies for those who chase their dreams fearlessly.
            </p>
          </div>
          ...
          {/* Puma Jackets Section with Marquee Animation - SAME AS OTHER BRANDS */}
          {!jacketsLoading && jackets.length > 0 && (
            <div className="border-t border-gray-200 pt-12 pb-8 mt-12">
              {/* Centered Heading */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-black mb-2">Puma Jackets</h2>
                <p className="text-gray-600 text-sm">
                  Explore our premium Puma jacket collection
                </p>
              </div>
