...
// Export jackets products array for use in other components
let jacketsProducts = [];
...
const Jackets = () => {
  ...
  // All available brands for filter
  const brandOptions = ["All", "Nike", "Adidas", "Puma", "New Balance", "Hoka", "Fila", "Under Armour", "Skechers"];

  // Gender options
  const genderOptions = ["All", "Men", "Women"];

  // Fetch jackets from Supabase
  useEffect(() => {
    const fetchJackets = async () => {
      try {
        ...
        jacketsProducts = transformedProducts;
  ...
  // Filter products based on gender and brand
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 p-3 rounded-lg">
                      ...
                      <p className="text-lg font-semibold text-black">{selectedProduct.height}</p>
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <p className="text-sm text-gray-600 mb-1">Width</p>
                      <p className="text-lg font-semibold text-black">{selectedProduct.width}</p>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="p-3 text-center flex flex-col justify-center flex-1">
                            ...
                            <div className="flex justify-center items-center gap-3 mb-2">
                              <div className="text-center">
                                ...
                                <p className="text-xs font-semibold text-black">{product.height}</p>
                              </div>
                              <span className="text-gray-300 text-xs">|</span>
                              <div className="text-center">
                                <p className="text-xs text-gray-500">Width</p>
                                <p className="text-xs font-semibold text-black">{product.width}</p>
                              </div>
                            </div>
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Jackets</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Stay stylish and protected with our premium jacket collection from top brands. 
              Find the perfect outerwear for every season and occasion.
            </p>
          </div>

          {/* Brand Filter */}
          <div className="mb-6 text-center">
            <h3 className="text-lg font-semibold text-black mb-3">Filter by Brand</h3>
          ...
          {loading && (
            <div className="text-center py-12">
              <p className="text-gray-600">Loading jackets...</p>
            </div>
          )}
                ...
                return (
                  <div key={product.id} className="bg-white border border-gray-200 flex flex-col hover:shadow-lg transition-shadow cursor-pointer relative" onClick={() => handleProductClick(product)}>
                    ...
                    <div className="p-4 text-center flex flex-col justify-center flex-1">
                      ...
                      {/* Measurements displayed prominently */}
          ...
          {!loading && filteredProducts.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-600">No jackets found for selected filters</p>
              <button
                onClick={() => {
