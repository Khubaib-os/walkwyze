...
const Womens = () => {
  ...
  // Fetch all women's products from ALL Supabase tables
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Women's Shoes</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the ultimate collection of women's footwear from top brands. 
              From stylish heels to comfortable sneakers, find the perfect pair for every occasion.
            </p>
          </div>
          ...
          {loading && (
            <div className="text-center py-12">
              <p className="text-gray-600">Loading women's products...</p>
            </div>
          )}
