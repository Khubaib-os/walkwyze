...
// Export Fila products array for use in other components
let filaProducts = [];
...
const Fila = () => {
  ...
  // Fetch Fila products from Supabase
  const fetchFilaProducts = async () => {
    try {
      setLoading(true);
      ...
      filaProducts = transformedProducts;
      setProducts(transformedProducts);
    } catch (error) {
      console.error('Error fetching Fila products:', error);
      filaProducts = [];
      setProducts([]);
    } finally {
      setLoading(false);
  ...
  // Fetch Fila jackets from jackets table
  const fetchFilaJackets = async () => {
    try {
      ...
      console.error('Error fetching Fila jackets:', error);
      setJackets([]);
    } finally {
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Fila</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Born in Italy, worn worldwide. Discover the latest Fila footwear collection featuring 
              iconic heritage designs, bold styles, and premium comfort for everyday wear.
            </p>
          </div>
          ...
          {loading && (
            <div className="text-center py-12">
              <p className="text-gray-600">Loading Fila products...</p>
            </div>
          )}
          ...
          {/* Fila Jackets Section with Marquee Animation - SAME AS OTHER BRANDS */}
          {!jacketsLoading && jackets.length > 0 && (
            <div className="border-t border-gray-200 pt-12 pb-8 mt-12">
              {/* Centered Heading */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-black mb-2">Fila Jackets</h2>
                <p className="text-gray-600 text-sm">
                  Explore our premium Fila jacket collection
                </p>
              </div>
