...
const Mens = () => {
  ...
  // Fetch all men's products from ALL Supabase tables
        ...
        try {
          ...
          if (data && data.length > 0) {
            ...
            const transformedProducts = data.map(product => ({
              id: product.id,
              uniqueId: `${table.split('_')[0]}-${product.id}`, // e.g., nike-123
              title: product.title,
              ...
              brand: table.split('_')[0].charAt(0).toUpperCase() + table.split('_')[0].slice(1), // Nike, Adidas, etc.
      ...
      <div className="min-h-screen bg-white pt-8 pb-24 md:pb-8">
        <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-black mb-4">Men's Shoes</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the ultimate collection of men's footwear from top brands. 
              From performance running shoes to stylish casual sneakers, find the perfect pair for every occasion.
            </p>
          </div>
          ...
          {/* Products Grid - WITHOUT ACTION BUTTONS */}
          {!loading && (
          ...
          {!loading && filteredProducts.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-600">No men's products found for {selectedSize !== "All" ? `size ${selectedSize}` : "selected filters"}</p>
              <button
