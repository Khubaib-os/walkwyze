// src/dashboard/UnderArmourMgt.jsx
import React, { useState, useEffect } from 'react';
import { supabase } from '../supabase';

const UnderArmourMgt = () => {
  ...
  return (
    <div className="p-4 mt-2 lg:mt-8 relative">
      <h2 className="text-xl font-bold text-black mb-4">Under Armour Products Management</h2>
            ...
            <div className="mt-3">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                <input
                  ...
                  className="hidden"
                  id="image-upload-underarmour"
                  disabled={uploading}
                />
                <label
                  htmlFor="image-upload-underarmour"
