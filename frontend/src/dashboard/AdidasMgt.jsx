...
const AdidasMgt = () => {
  ...
  return (
    <div className="p-4 mt-2 lg:mt-8 relative">
      <h2 className="text-xl font-bold text-black mb-4">Adidas Products Management</h2>
            ...
            <div className="mt-3">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                <input
                  ...
                  className="hidden"
                  id="image-upload-adidas"
                  disabled={uploading}
                />
                <label
                  htmlFor="image-upload-adidas"
